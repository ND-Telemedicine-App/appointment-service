...
public class AppointmentServiceApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        ...
        Appointment newAppointment2 = new Appointment(2L, 3L, 1L, "2022-10-25 15:00:00.000", "2022-10-25 15:30:00.000", "This is a description");
        appointmentRepo.save(newAppointment2);

        Appointment newAppointment3 = new Appointment(3L, 4L, 1L, "2022-10-27 09:00:00.000", "2022-10-27 09:30:00.000", "This is a description");
        appointmentRepo.save(newAppointment3);

        Appointment newAppointment4 = new Appointment(4L, 3L, 2L, "2022-10-22 10:00:00.000", "2022-10-22 10:30:00.000", "This is a description");
